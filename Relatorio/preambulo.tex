...
\theoremstyle{number-name}
  ...
  \newtheorem{theorem}[lemma]{\color{thm}Teorema:}
  \newtheorem{proposition}[lemma]{\color{prop}Proposição:}
  \newtheorem{corollary}[lemma]{\color{crl}Corolário:}
  \newtheorem{definition}[lemma]{\color{def}Definição:}
